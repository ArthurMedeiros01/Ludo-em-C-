                ...
                if (valorDado2 == 6)
                {
                    ...
                    else
                    {
                        ...
                        while (o < 1)
                        {
                            ...
                            if (VerificarDisponibilidadePeao(peaoEscolhido, valorDado1))
                            {
                                bool verificacao = VerificarDisponibilidadePeao(peaoEscolhido, valorDado1);
                                if (verificacao == true)
                                {
                            ...
                            {
                                o++;
                                Console.WriteLine("não há jogadas possíveis");
                            }
                        ...
                        while (o < 1)
                        {
                            ...
                            if (VerificarDisponibilidadePeao(peaoEscolhido2, valorDado2))
                            {
                                bool verificacao = VerificarDisponibilidadePeao(peaoEscolhido2, valorDado2);
                                if (verificacao == true)
                                {
                        ...
                        while (o < 1)
                        {
                            ...
                            if (VerificarDisponibilidadePeao(peaoEscolhido3, valorDado3))
                            {
                                bool verificacao = VerificarDisponibilidadePeao(peaoEscolhido3, valorDado3);
                                if (verificacao == true)
                                {
